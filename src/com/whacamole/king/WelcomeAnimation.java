...
public class WelcomeAnimation extends Activity implements OnViewChangeListener {
			...
			case R.id.startBtn:
				...
				leftOutAnimation.setAnimationListener(new AnimationListener() {
					...
					public void onAnimationEnd(Animation animation) {
						...
						Intent intent = new Intent(WelcomeAnimation.this,
								OtherActivity.class);
						WelcomeAnimation.this.startActivity(intent);
						WelcomeAnimation.this.finish();
